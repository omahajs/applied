 ...
 * @module atmosphere
 * @prop {object} convert
 * @prop {function} convert.metersPerSecondToMach
 * @prop {object} calculate
 * @prop {function} calculate.molecularTemperature
 * @prop {function} calculate.kineticTemperature
 * @prop {function} calculate.speedOfSound
 * @prop {function} getStrata
 * @prop {function} molecularWeight
...
let calculate = {
    molecularTemperature: getMolecularTemperature,
    kineticTemperature: getKineticTemperature,
