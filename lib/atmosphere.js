...
**/
function getStrata(altitude: number) {
...
**/
function molecularWeight(i: number) {
...
**/
function getMolecularTemperature(altitude: number) {
...
function getKineticTemperature(altitude: number): number {
    ...
    let dh = delta(h);
    let Tm = getMolecularTemperature(altitude);
