...
define(function(require, exports, module) {
    ...
    **/
    var DATUM = Object.create(null, {
        EARTH_EQUATOR_RADIUS:       {enumerable: true, value: 6371001},
        EARTH_MEAN_RADIUS:          {enumerable: true, value: 6378137},
    ...
    var convert = {
        cartesianToGeodetic:     _.flow(formatInput, convertCartesianToGeodetic),
        geodeticToCartesian:     _.flow(formatInput, convertGeodeticToCartesian),
        toDecimalDegrees:        _.flow(formatInput, toDecimalDegrees),
        toDegreesDecimalMinutes: _.flow(formatInput, toDegreesDecimalMinutes),
        toDegreesMinutesSeconds: _.flow(formatInput, toDegreesMinutesSeconds)
    };
    module.exports = {
        DATUM: DATUM,
        FORMATS: FORMATS,
    ...
    **/
    function getRadius(theta) {
        ...
        return DATUM.SEMI_MAJOR_AXIS * (1 - (DATUM.FLATTENING * squared(SIN_THETA)));
    }
    /**
     ...
     * @property {array} point [latitude, longitude, height]
     * @returns {array} [x, y, z]
    **/
     ...
     * @memberof module:geodetic
     * @property {array} point [x, y, z]
     * @returns {array} [latitude, longitude, height]
