...
define(function(require, exports, module) {
    ...
    **/
     ...
     * @example
     * convertToDegreesMinutesSeconds([32.8303, 0, 0]); // [32, 49, 49.0800]
     * convertToDegreesMinutesSeconds([32, 49.818, 0]); // [32, 49, 49.0800]
    **/
     ...
     * @returns {number[]} [degrees, minutes, seconds]
     * @example
     * convertToDegreesDecimalMinutes([32.8303, 0, 0]);   // [32, 49.818]
     * convertToDegreesDecimalMinutes([32, 49, 49.0800]); // [32, 49.818]
    **/
     ...
     * @returns {number}
     * @example
     * convertToDecimalDegrees(['32', '49', '49.0800']) // 32.8303
    **/
