...
define(function(require, exports, module) {
    ...
    **/
     ...
     * @example <caption>Radius at equator (latitude === 0)</caption>
    ...
    **/
     ...
     * @example
     * var geodetic = require('applied').geodetic;
     * geodetic.convert.toDegreesMinutesSeconds([32.8303, 0, 0]); // [32, 49, 49.0800]
     * geodetic.convert.toDegreesMinutesSeconds([32, 49.818, 0]); // [32, 49, 49.0800]
    **/
     ...
     * @example
     * var geodetic = require('applied').geodetic;
     * geodetic.convert.toDegreesDecimalMinutes([32.8303, 0, 0]);   // [32, 49.818]
     * geodetic.convert.toDegreesDecimalMinutes([32, 49, 49.0800]); // [32, 49.818]
    **/
     ...
     * @example
     * var geodetic = require('applied').geodetic;
     * geodetic.convert.toDecimalDegrees(['32', '49', '49.0800']) // 32.8303
    **/
