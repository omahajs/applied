...
define(function(require, exports, module) {
    ...
    **/
     ...
     * var geodetic = require('applied').geodetic;
     * var val = [32.8303, 0, 0];
     * geodetic.convert.toDegreesMinutesSeconds(val);// [32, 49, 49.0800]
     * @example <caption>Convert decimal degree minutes value</caption>
     * var geodetic = require('applied').geodetic;
     * var val = [32, 49.818, 0];
     * geodetic.convert.toDegreesMinutesSeconds(val);// [32, 49, 49.0800]
    **/
     ...
     * @example <caption>Convert degree minutes seconds value</caption>
     * var geodetic = require('applied').geodetic;
    ...
    **/
     ...
     * var geodetic = require('applied').geodetic;
     * var val = ['32', '49', '49.0800'];
     * geodetic.convert.toDecimalDegrees(val);// 32.8303
    **/
